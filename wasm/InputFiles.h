...
public:
  ...
  std::string getArisenABI() const { return arisen_abi; }
  ArrayRef<StringRef> getArisenActions() const { return arisen_actions; }
  ArrayRef<StringRef> getArisenNotify() const { return arisen_notify; }
private:
  std::string arisen_abi;
  ArrayRef<StringRef> arisen_actions;
  ArrayRef<StringRef> arisen_notify;
